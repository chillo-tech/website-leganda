            ...
            <div className="bg-gray opacity-200 header-content absolute bottom-0 top-0 left-0 right-0">
              <div className="bg-black-rgba w-full pt-5 px-3 md:px-10 h-screen mx-auto flex flex-col justify-between">
                ...
                <div className="container">
                  <div className="text-2xl md:text-8xl font-extrabold text-white">Retrouvez</div>
                  <div className="text-2xl md:text-8xl py-4 font-extrabold text-white py-4 text-orange-600">{HEADERS_ITEMS[displayedItemIndex]['label']}</div>
                  <div className="text-2xl md:text-8xl font-extrabold text-white">Près de vous</div>
